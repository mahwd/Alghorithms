...
const findTrappedWater = (arr) => {
    const n = arr.length;
    const high_bars_left = [arr[0]];
    const high_bars_right = [];
...
findTrappedWater(elevation_map);
const endTime = perf_hooks_1.performance.now();
console.log(`Finding trapping water amount of elevation map took: ${endTime - startTime} milliseconds`);
//# sourceMappingURL=elevation_map.js.map